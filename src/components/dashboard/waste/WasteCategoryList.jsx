...
//         <th className="p-2 border border-gray-300">Recyclable</th>
//         <th className="p-2 border border-gray-300">Hazardous</th>
...
//           <td className="p-2 border border-gray-300">{category.recyclable ? 'Yes' : 'No'}</td>
