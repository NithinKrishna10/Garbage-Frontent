...
//   //   try {
//   //     const response = await axios.get('/admin/orders'); // Replace '/api/orders/' with your API endpoint URL
...
//   const fetchOrders = () => {
//     axios
//       .get("adminside/orders") // Replace '/api/orders/' with your API endpoint URL
//       .then((response) => {
//         setOrders(response.data);
//         console.log(response.data);
//       })
...
//               <td className="py-2">{order.waste_type.name}</td>
//               <td className="py-2">
...
//               </td>
//               <td>{order.price}</td>
//               <td>{order.waste_weight}</td>
//               <td className="py-2">{order.pickup_date}</td>
...
//     <div className="overflow-x-auto md:w-[100vh] max-w-[90vw]">
//       <h1 className="text-2xl font-bold mb-4">Order List</h1>
//       <table className="min-w-full divide-y divide-gray-200">
//         {/* Table header */}
//         {/* ... */}
...
//                   <td className="py-2" onClick={()=>{ navigate()}}>Udate</td>
