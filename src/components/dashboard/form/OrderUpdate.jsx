...
//   const updateOrder = () => {
//     const updatedOrder = { ...order, additional_notes: additionalNotes };

//     axios.patch(`/adminside/orders/${id}/`, updatedOrder)
//       .then(response => {
...
//   const deleteOrder = () => {
//     axios.delete(`/adminside/orders/${id}`)
//       .then(response => {
...
const OrderUpdate = () => {
  ...
  return (
    ...
    //   <h1 class="text-2xl font-bold mb-4 text-center text-white bg-indigo-500">Order Detail</h1>
    //   <p class="mb-4">Order ID: <span class="text-gray-500 text-2xl">{order.id}</span></p>
    //   <div class="mb-4">
    //     <label class="block mb-2">Price</label>
    //     <input
    //       type="number"
    //       class="w-full rounded-md px-2 py-1 border-gray-300 focus:border-indigo-500 focus:outline-none  bg-gray-100"
    //       value={price}
    //       onChange={(event) => setPrice(event.target.value)}
    //     />
    //   </div>
    ...
    //     <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md w-1/2" onClick={updateOrder}>Update Order</button>
    //     <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-md w-1/2" onClick={deleteOrder}>Delete Order</button>
    //   </div>
    // </div>
